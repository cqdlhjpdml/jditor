!function(window) {
    ...
    JTopo = {
        ...
        //createStageFromJson: function(jsonStr, canvas)//dml:funciton declaration changed to next line
        createStageFromJson: function(jsonStr, canvas,stage) {
            eval("var jsonObj = " + jsonStr);
            if(stage) stage.clear();
            else {var stage = new JTopo.Stage(canvas);}
            ...
            return scenes.forEach(function(a) {
                ...
                d.forEach(function(a) {
                    ...
                    if("node"==d){c=new JTopo.Node;}
                    else if("CircleNode"==d){c = new JTopo.CircleNode;}
                    else if("SvgNode"==d) {c=new JTopo.SvgNode(a['symbolType'],a['text']);}
                    for (var e in a)
                        c[e] = a[e];
                    b.add(c)
                })
...
function(a) {//stage
    ...
    function c(c) {
        ...
        ,
        this.dispatchEventToScenes = function(a, b) {            if (0 != this.frames && (this.needRepaint = !0),
...
function(a) {//Scene
    function b(c) {
        ...
        ,
        this.initialize(),
        this.setSymbolFile=function (fullFileName){this.symbolFile=fullFileName},//this line added by dml
        this.loadSymbolFromFile=function(loader){//this function added by dml
            this.symbols=loader.loadSymbol(this.symbolFile);
        },
        ...
        this.hide = function() {
            this.visible = !1;
            this.mouseOverelement=null;//dml
            this.currentElement=null;//dml
        }
        ,
        ...
        this.mousedragHandler = function(b) {
            var c = this.toSceneEvent(b);
            if(this.currentElement==null) return;// dml:don't move elements when clickdown no any element.
            ...
            this.mode == a.SceneMode.normal ?//dml:changed to following 
...
function(a) {
    function b() {//DisplayElement
        this.initialize = function() {
            ...
            this.zIndex = 0;
            this.connectors=[];//this statement added by dml
        ...
        this.addConnector=function(cn){this.connectors.push(cn);}//function added by dml
        ,
        ...
        this.getPosition = function(a) {
            ...
            if("Rotate_Handle"==a) return {x:c.right+15,y:c.top-15} //dml's codes,rotate_handle located at the up of the Top_Center
            return "Top_Left" == a ? b = {
                x: c.left,
                y: c.top
            } : "Top_Center" == a ? b = {
    ...
    function c() {//InteractiveElement
        this.initialize = function() {
            ...
            this.isMouseOver = !1;
            this.mDragging=0;//this line added by dml
        ...
        this.unselectedHandler = function() {
            this.selected = !1;
            //this.selectedLocation = null  // dml omitted the statement  to let the connector to remember its location if 
                                            //the unselected node's elementType is the Connector Type 
        }
        ,
        this.dbclickHandler = function(a) {
        ...
        var b = "click,dbclick,mousedown,mouseup,mouseover,mouseout,mousemove,mousedrag,touchstart,touchmove,touchend".split(",")
          , d = this;
        b.push("onRotated");//this line added by dml
        b.push("onResize");////this line added by dml
    ...
    function d() {//EditableElement
        ...
        this.isInBound = function(a, c) {
            //dml begin:take care of rotate，conversion point(a,c) to the coordinate value before roatated .
            var r=Math.sqrt((a-this.cx)*(a-this.cx)+(c-this.cy)*(c-this.cy));
            var theta=Math.atan2((c-this.cy),(a-this.cx))-this.rotate;
            a=this.cx+r*Math.cos(theta);
            c=this.cy+r*Math.sin(theta);
...
function(a) {
    function b(c) {//node---dml
        this.initialize = function(c) {
            ...
            this.dragable = !0,
            this.customPaintMode=2;//this line added by dml,2---  the paint function's codes executed and then to call customPaint function.  1---  skip over the paint fcunction's other codes, just call the customPaint function
        ...
        this.paint = function(a) {
            ...
            if (this.image) {
                ...
                a.globalAlpha = b
            } else if(this.toFill){//dml add:if(this.toFill)
                a.beginPath(),
                a.fillStyle = "rgba(" + this.fillColor + "," + this.alpha + ")",
        ...
        ,
        this.removeHandler = function(a) {//a:scene object
            var b = this;
            ...
            this.inLinks && (this.inLinks.forEach(function(c) {
                c.nodeZ === b && a.remove(c)//dml:???????scene.remove的间接递归调用
            }),
            this.inLinks = null);
            //dml begin:remove this node's connectors
            b.connectors.forEach(function(cn){
                a.remove(cn) 
            })
            //dml end
        }
...
function(a) {
    ...
    function h(a, b, c) {//FlexionalLink
        this.initialize = function() {
